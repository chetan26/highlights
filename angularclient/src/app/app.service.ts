...
export class AppService {
  dataObservable: any;
  responseData = `<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  <!-- saved from url=(0037)https://www.w3.org/Provider/Style/URI -->
  <html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    <title>Hypertext Style: Cool URIs don't change.</title>
    <link rel="Stylesheet" href="./cool-uris-dont-change_files/GuideStyle.css">

  </head>

  <body bgcolor="white" text="black" link="blue" vlink="green" lang="en">
  <p><a href="https://www.w3.org/"><img src="./cool-uris-dont-change_files/w3c_home.gif" alt="W3C" border="0"></a> <a href="https://www.w3.org/Provider/Style/"><img src="./cool-uris-dont-change_files/style_48x48.gif" alt="Style Guide" border="0"></a></p>
  <hr>

  <h1>Cool URIs don't change1</h1>

  <blockquote>
    What makes a cool URI?<br>
    A cool URI is one which does not change.<br>
    What sorts of URI change?<br>
    <i>URIs don't change: people change them.</i></blockquote>

  <p>There are no reasons at all in theory for people to change URIs (or stop
  maintaining documents), but millions of reasons in practice.</p>

  <p>In theory, the domain name space owner owns the domain name space and
  ...
  reasons you hear out there:</p>

  <h4>We just reorganized our website to make it better.</h4>

  <p>Do you really feel that the old URIs cannot be kept running? If so, you
  chose them very badly. Think of your new ones so that you will be able to
  keep then running after the next redesign.</p>

  <h4>We have so much material that we can't keep track of what is out of date
  and what is confidential and what is valid and so we thought we'd better just
  turn the whole lot off.</h4>

  <p>That I can sympathize with - the W3C went through a period like that, when
  ...
  expiry date. Keep this metadata.</p>

  <h4>Well, we found we had to move the files...</h4>

  <p>This is one of the lamest excuses. A lot of people don't know that servers
  ...
  to make it just right.</p>

  <p>John doesn't maintain that file any more, Jane does.</p>

  <p>Whatever was that URI doing with John's name in it? It was in his
  directory? I see.</p>

  <h4>We used to use a cgi script for this and now we use a binary program.</h4>

  <p>There is a crazy notion that pages produced by scripts have to be located
  ...
  and whoops - all your URIs change.</p>

  <p>For example, take the National Science Foundation:</p>

  <p><i>NSF Online Documents</i><br>
  <tt>http://www.nsf.gov/cgi-bin/pubsys/browser/odbrowse.pl</tt></p>

  <p>the main page for starting to look for documents, is clearly not going to
  ...
  you use the page to find a document, you get first an equally bad</p>

  <p><i>Report of Working Group on Cryptology and Coding Theory</i><br>
  <tt>http://www.nsf.gov/cgi-bin/getpub?nsf9814</tt></p>

  <p>for the document's index page, but the html document itself by contrast is
  very much better:</p>

  <p><tt>http://www.nsf.gov/pubs/1998/nsf9814/nsf9814.htm</tt></p>

  <p>Looking at this one, the "pubs/1998" header is going to give any future
  ...
  the archive not being at all embarrassed about it.</p>

  <h4>I didn't think URLs have to be persistent - that was URNs.</h4>

  <p>This is the probably one of the worst side-effects of the URN discussions.
  ...
  <p>Most URN schemes I have seen look something like an authority ID followed
  ...
  <p>If you have gotten to this point, then unless you have the time and money
  and contacts to get some software design done, then you might claim the next
  excuse:</p>

  <h4>We would like to, but we just don't have the right tools.</h4>

  <p>Now here is one I can sympathize with. I agree entirely. What you need to
  ...
  <p>You need to be able to change things like ownership, access, archive level
  security level, and so on, of a document in the URI space without changing
  the URI.</p>

  <p>Too bad. But we'll get there. At W3C we use <em>Jigedit</em> functionality
  (<em>Jigsaw </em>server used for editing) which does track versions, and we
  are experimenting with document creation scripts. If you make tools, servers
  and clients, take note!</p>

  <p>This is an outstanding reason, which applies for example to many W3C pages
  including this one: so do what I say, not what I do.</p>

  <h2>Why should I care?</h2>

  <p>When you change a URI on your server, you can never completely tell who
  ...
  in the margin of a letter to a friend.</p>

  <p>When someone follows a link and it breaks, they generally lose confidence
  in the owner of the server. They also are frustrated - emotionally and
  practically from accomplishing their goal.</p>

  <p>Enough people complain all the time about dangling links that I hope the
  damage is obvious. I hope it also obvious that the reputation damage is to
  the maintainer of the server whose document vanished.</p>

  <h2>So what should I do? Designing URIs</h2>

  <p>It is the the duty of a Webmaster to allocate URIs which you will be able
  to stand by in 2 years, in 20 years, in 200 years. This needs thought, and
  organization, and commitment.</p>

  <p>URIs change when there is some information in them which changes. It is
  ...
  <p>The creation date of the document - the date the URI is issued - is one
  ...
  <p>The only exception is a page which is deliberately a "latest" page for,
  for example, the whole organization or a large part of it.</p>

  <p><tt>http://www.pathfinder.com/money/moneydaily/latest/</tt></p>

  <p>is the latest "Money daily" column in "Money" magazine. The main reason
  ...
  <i>Money</i>" vanishes if <i>Money</i> goes out of production. If you want to
  link to the content, you would link to it where it appears separately in the
  archives as</p>

  <p><tt>http://www.pathfinder.com/money/moneydaily/1998/981212.moneyonline.html</tt></p>

  <p>(Looks good. Assumes that "money" will mean the same thing throughout the
  life of pathfinder.com. There is a duplication of "98" and an ".html" you
  don't need but otherwise this looks like a strong URI).</p>

  <h3>What to leave out</h3>

  <p>Everything! After the creation date, putting any information in the name
  is asking for trouble one way or another.</p>
  <ul>
    <li><b>Authors name</b>- authorship can change with new versions. People
      quit organizations and hand things on.</li>
    <li><b>Subject</b>. This is tricky. It always looks good at the time but
      changes surprisingly fast. I discuss this more below.</li>
    <li><b>Status</b>- directories like "old" and "draft" and so on, not to
      ...
      status is. Keep the status out of the name.</li>
    <li><b>Access</b>. At W3C we divide the site into "Team access", "Member
      ...
      all the old links to it fail! We are switching to a simple date code
    now.</li>
    <li><b>File name extension</b>. This is a very common one. "cgi", even
      ...
      still be valid. The canonical way of making links to the W3C site doesn't
      use the extension.(<a href="https://www.w3.org/Provider/Style/URI#remove">how?</a>)</li>
    <li><b>Software mechanisms</b>. Look for "cgi", "exec" and other give-away
      ...
      server manual on how to do it.</li>
    <li>Disk name - gimme a break! But I've seen it.</li>
  </ul>
  ...
  <p><tt>http://www.w3.org/1998/12/01/chairs</tt></p>

  <p>a report of the minutes of a meeting of W3C chair people.</p>

  <h4>Topics and Classification by subject</h4>

  <p>I'll go into this danger in more detail as it is one of the more difficult
  ...
  "Stylesheets" for example in our short life.</p>

  <p>This is a tempting way of organizing a web site - and indeed a tempting
  way of organizing anything, including the whole web. It is a great medium
  term solution but has serious drawbacks in the long term</p>

  <p>Part of the reasons for this lie in the philosophy of meaning. every term
  ...
  <p>Effectively, when you use a topic name in a URI you are binding yourself
  to some classification. You may in the future prefer a different one. Then,
  the URI will be liable to break.</p>
  ...
  your server "what we meant in 1998 by <i>pics</i>", rather than "what in 1998
  we did with what we now refer to as <i>pics</i>."</p>

  <h3>Don't forget the domain name.</h3>

  <p>Remember that this applies not only to the "path" part of a URI but to the
  ...
  server using redirection and proxying.</p>

  <p>Oh, and do think about your domain name. If your name is not soap, will
  ...
  <p>Keeping URIs so that they will still be around in 2, 20 or 200 or even
  ...
  stay the same. They only can if you think about how you design them.</p>

  <p>See also:</p>
  <ul>
    <li><a href="http://www.useit.com/alertbox/990321.html">Jacob Nielsen's
      "Alertbox" rant on the same topic</a></li>
  </ul>

  <p></p>
  <hr>
  (back to <a href="https://www.w3.org/Provider/Style/Etiquette.html">Etiquette for server administrators</a>, on
  to <a href="https://www.w3.org/Provider/Style/Structure.html">Structure of your work</a>)

  <h3></h3>

  <h3>Footnote</h3>

  <h3><a name="remove">How can I remove the file extensions</a>...</h3>

  <p>...from my URIs in a practical file-based web server?</p>

  <p>If you are using, for example, Apache, you can set it up to do content
  negotiation. You keep the file extension (such as .png) on the file (e.g.
  <code>mydog.png</code>), but refer to the web resource without it. Apache
  ...
  <em>not</em> have to put different types of file in different directories, in
  fact the content negotiation won't work if you do.)</p>
  <ul>
    <li>Set up your server to do content negotiation</li>
    <li>Make references always to the URI without the extension</li>
  </ul>

  <p>References which do have the extension on will still work but will not
  allow your server to select the best of currently available and future
  formats.</p>

  <p>(In fact, <code>mydog</code>, <code>mydog.png</code> and
  <code>mydog.gif</code> are each valid web resources. <code>mydog</code> is
  content-type-generic. <code>mydog.png</code> and <code>mydog.gif</code> are
  content-type-specific.)</p>

  <p>Of course, if you are building your own server, then using a database to
  relate persistent identifiers to their current  form is a very clean idea --
  though beware the unbounded growth of your database.</p>

  <h3>Hall of flame --  story 1: Channel 7</h3>

  <p>During 1999, <code>http://www.whdh.com/stormforce/closings.shtml</code>
  ...
  <p>Can't be such a big storm.  Funny the date is missing. But then if I go to
  the home page of the site, there is a big button "school closings" which
  takes me to <code>http://www.whdh.com/stormforce/</code> which has a list of
  many closed schools.</p>

  <p>Well, maybe they changed the system which got the closings from the
  definitive list - but they did not need to change the URI.</p>

  <h3>Hall of flame -- story 2: Microsoft Netmeeting</h3>

  <p>One of the smarts which came with a growing dependency on the web was that
  ...
  probably fixed it by now...</p>

  <p></p>
  <address>
    (c)1998 <a name="0" href="https://www.w3.org/People/Berners-Lee/">Tim BL</a>
  </address>

  <p>Historical note: At the end of the 20th century when this was written,
